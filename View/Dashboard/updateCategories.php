        ...
        <section class="content-section">
            <div class="px-4 row d-flex justify-content-center">
                <div class="col-xl-6 col-md-9 col-sm-9 col-9 fs-6 " style="width:100%">
                    <form method="post" action="/submitupdateCategorie" >
                        <div class="mb-4">
                            <div >
                                <h2>UPDATE CATEGORIES</h2>
                                <input type="hidden" name="id" value="<?= $categorie->id ?>" class="form-control task-desc">

                            </div>
                            <label class="form-label">categorie</label>
                            <input type="text" name="name" value="<?=$categorie->NAME?>" class="form-control task-desc">
                        </div>
                        ...
                        <div class="d-flex w-100 justify-content-center">
                            ...
                            <a href="/categories" class="btn btn-danger btn-block mb-4" >ANNULER</a>
                        </div>
                    </form>
